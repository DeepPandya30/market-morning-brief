...
@media (prefers-reduced-motion: reduce) {
  *, header, .live-dot { animation: none !important; transition: none !important; }
  .reveal { opacity: 1; transform: none; }
    ...
    /* AI summary — compact */
    .ai-card { background: linear-gradient(135deg, rgba(37,99,235,.10), var(--card) 55%); border-color: rgba(37,99,235,.3); padding: 13px 15px; margin-bottom: 14px; }
    .ai-card .card-head { margin-bottom: 9px; }
    .ai-card .card-head h2 { font-size: 15px; }
    .ai-card .badge { font-size: 10.5px; padding: 2px 8px; }
    .summary-list { list-style: none; margin: 0; padding: 0; display: grid; gap: 6px 22px; }
    .summary-list li { display: flex; gap: 8px; align-items: flex-start; font-size: 12.8px; line-height: 1.38; color: var(--muted); }
    .summary-list li b { color: var(--text); }
    .summary-list li .dot { flex: 0 0 auto; width: 6px; height: 6px; border-radius: 50%; margin-top: 5px; background: var(--brand); }
    @media (min-width: 1000px) { .summary-list { grid-template-columns: 1fr 1fr; } }
...
<main>
  ...
  <section id="sectors" class="panel">
    <div class="card">
      <div class="card-head"><h2>Sector Heatmap</h2><span class="badge info">Sorted by change %</span></div>
      <div class="controls">
    ...
    <div class="card">
      <div class="card-head"><h2>India Sector View</h2></div>
      <div class="table-wrap"><table><thead><tr><th>Sector</th><th>Last</th><th>Change</th><th>Change %</th></tr></thead><tbody id="sectorRows"></tbody></table></div>
    </div>
  </section>
